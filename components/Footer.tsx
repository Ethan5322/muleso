            ...
            <div className="flex gap-3">
              {s.linkedin && (
                <a href={s.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                  className="text-[var(--text-secondary)] hover:text-[var(--color-action-on-dark)] transition-colors">
                  <LinkedInIcon />
                </a>
              )}
              {s.twitter && (
              ...
              {['Website Design', 'AI Chatbots', 'Logo Design', 'QR Codes', 'Custom Email', 'PDF Guides'].map(
                (service) => (
                  <li key={service}>
                    <Link
                      href="/services"
                      className="text-[var(--text-secondary)] hover:text-[var(--color-action-on-dark)] transition-colors text-sm"
                    >
                      {service}
                    </Link>
                  </li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <Mail size={18} className="text-[var(--color-action-on-dark)] mt-1 flex-shrink-0" />
                <a
                  href={`mailto:${s.email}`}
                  className="text-[var(--text-secondary)] hover:text-[var(--color-action-on-dark)] transition-colors text-sm break-all"
                >
                  {s.email}
                </a>
              </div>
              ...
              <div className="flex items-start gap-3">
                <MapPin size={18} className="text-[var(--color-action-on-dark)] mt-1 flex-shrink-0" />

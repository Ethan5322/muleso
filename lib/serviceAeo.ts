...
export const SERVICE_AEO: ServiceAeo[] = [
  ...
  },
  {
    ...
    answer:
      'MuleSoo Digital Services turns expertise into professionally designed PDF guides you can sell online, from R149. Each guide is laid out to a publishable standard, distributed securely so it cannot be freely copied around, and tracked so you can see what sells. Once written, a guide earns without any further work from you.',
    faqs: [
      {
      ...
      },
      {
        ...
        a: 'Guide production starts at R149 depending on length and how much design and structuring the content needs. ' + CONTACT,
      },
    ],
  },
  {

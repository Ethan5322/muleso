...
export default function VisitorsPage() {
  ...
  const COLORS = ['var(--color-action-primary)', '#7B2FFF'];
          ...
          >
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={chartData}>
                <CartesianGrid strokeDasharray="3 3" stroke="var(--color-action-primary)20" />
                <XAxis dataKey="date" stroke="var(--color-action-primary)" />
                ...
                />
                <Bar dataKey="visitors" fill="var(--color-action-primary)" radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </motion.div>

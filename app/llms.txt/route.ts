...
## Services and starting prices (South African Rand, ZAR)
- Website Design — from R3,500
- AI Chatbots — from R2,500
- Design Widget (website support + sales chat widget) — from R3,500
- AI Automation — 200 ready systems across 9 industries — from R4,500
...
- PDF Guides (online store) — R149 to R349
...
- PDF Guides (from R149): ${SITE}/services/pdf-guides
...
A: MuleSoo websites start from R3,500, with business sites from R7,500 and enterprise builds higher, depending on scope.

Q: What is an AI chatbot / booking assistant?
A: An AI assistant on your website and WhatsApp that answers customers 24/7, captures leads, books appointments and takes deposits automatically. MuleSoo AI chatbots start from R2,500.

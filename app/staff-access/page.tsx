    ...
    <div className="min-h-screen bg-[#050810] text-[#F0F2FA] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="space-y-3">
          ...
          <a
            href="/"
            className="flex items-center gap-4 p-5 rounded-2xl glass-card border border-[var(--border)] hover:border-[var(--color-action-on-dark)] transition-colors"
          >
            <span className="w-11 h-11 rounded-xl bg-[var(--glow-action)] text-[var(--color-action-on-dark)] flex items-center justify-center">
              <Globe size={22} />
            </span>
            <span>

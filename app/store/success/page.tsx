        ...
        {state === 'done' && (
          <>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.div whileHover={{ scale: 1.05 }}>
                <Link href="/store" className="inline-block px-8 py-3 border-2 border-[var(--color-action-on-dark)] text-[var(--color-action-on-dark)] font-bold font-sora rounded-lg hover:bg-[var(--glow-action)] hover:shadow-lg hover:shadow-[var(--glow-action)]/50 transition-all">
                  Explore More Guides
                </Link>
              </motion.div>
            </div>
        ...
        {state === 'error' && (
          <>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.div whileHover={{ scale: 1.05 }}>
                <Link href="/store" className="inline-block px-8 py-3 border-2 border-[var(--color-action-on-dark)] text-[var(--color-action-on-dark)] font-bold rounded-lg hover:bg-[var(--glow-action)] hover:shadow-lg hover:shadow-[var(--glow-action)]/50 transition-all">
                  Back to Store
                </Link>
              </motion.div>
            </div>

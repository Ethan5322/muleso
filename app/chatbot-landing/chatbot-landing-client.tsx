...
export default function ChatbotLandingClient() {
  return (
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-sm text-[var(--text-secondary)] mt-6">
              💬 Or WhatsApp: <a href="https://wa.me/27688529333" className="text-[var(--color-action-on-dark)] hover:underline">Chat Now</a>
            </p>
          </motion.div>
        </div>
      </section>

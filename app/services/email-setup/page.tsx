  ...
  return (
    <div className="min-h-screen py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <PageHero
          title="Professional Custom Email Setup"
          subtitle="Your own @yourdomain.com email for instant credibility and trust."
        />
        ...
        >
          <h2 className="text-4xl font-bold font-sora mb-6 gradient-text">Professional Email Setup</h2>
          <p className="text-xl text-[var(--text-secondary)] mb-8 max-w-2xl mx-auto">
            We handle everything from domain configuration to email setup, so you can focus on your business.
          </p>
          ...
          <p className="text-sm text-[var(--text-secondary)]">
            Tell us your email needs and get a custom package quote within 2 hours.
          </p>
        </motion.div>
      </div>
    </div>

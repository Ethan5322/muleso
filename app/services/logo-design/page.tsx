  ...
  return (
    <div className="min-h-screen py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl font-bold font-sora mb-6 gradient-text">Custom Logo Design</h2>
          <p className="text-xl text-[var(--text-secondary)] mb-8 max-w-2xl mx-auto">
            We create professional, memorable logos that reflect your brand's unique identity and values.
          </p>

          <div className="mb-8 space-y-4">
            <p className="text-lg text-[var(--accent-blue)] font-sora font-bold">
              💬 Contact Ethan for Custom Pricing & Packages
            </p>
          ...
          <p className="text-sm text-[var(--text-secondary)]">
            Share your brand vision and get a custom quote within 2 hours.
          </p>
        </motion.div>
      </div>
    </div>
